...
<template>
    <DashboardLayout>
        <template v-slot:default>
            <section class="bg-white dark:bg-gray-900 dark:bg-black" v-if="isPrice">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        ...
                        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400 dark:text-white">Here at
                            Flowbite we focus
                    ...
                    <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        <!-- Pricing Card -->
                        <div
                            class=" dark:bg-boxdark flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                            ...
                            <a href="#" @click="getStart('start')"
                                class="text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Get
                                started</a>
                        </div>
                        <!-- Pricing Card -->
                        <div
                            ...
                            <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Relevant for multiple
                                users, extended & premium support.</p>
                            <div class="flex justify-center items-baseline my-8">
